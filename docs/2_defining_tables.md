...
| `Field('name', 'string', requires=IS_IN_SET([...]))` | `name: Literal["a", "b"]` or `name: MyEnum` | `name: TypedField[Literal["a", "b"]]` or `name: TypedField[MyEnum]` | `name = TypedField(Literal["a", "b"])` or `name = TypedField(MyEnum)` | `name = StringField(requires=IS_IN_SET([...]))` |
...
This can be done just as web2py does (
